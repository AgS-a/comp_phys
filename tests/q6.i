...
# 77 "q6.c" 3 4
                    2147483647
# 77 "q6.c"
                    +1.0)) * ((upper_limit) - (lower_limit))) + lower_limit;
                double r2 =
                    (((double) rand() / (
# 79 "q6.c" 3 4
                    2147483647
# 79 "q6.c"
                ...
                double theta1 = acos(2 * ((double) rand() / (
# 81 "q6.c" 3 4
                                        2147483647
# 81 "q6.c"
                                        +1.0)) - 1);
                double theta2 = acos(2 * ((double) rand() / (
# 82 "q6.c" 3 4
                                        2147483647
# 82 "q6.c"
                                        +1.0)) - 1);

                double phi1 = ((double) rand() / (
# 84 "q6.c" 3 4
                             2147483647
# 84 "q6.c"
                             +1.0)) * 2 * 3.1415;
                double phi2 = ((double) rand() / (
# 85 "q6.c" 3 4
                             2147483647
# 85 "q6.c"
                             +1.0)) * 2 * 3.1415;
...
double imp_integral(int n, double *err)
{
        ...
        for (int i = 0; i < n; i++) {
                double r1 = -log(((double) rand() / (
# 120 "q6.c" 3 4
                                2147483647
# 120 "q6.c"
                                +1.0))) / (2 * alpha);
                double r2 = -log(((double) rand() / (
# 121 "q6.c" 3 4
                                2147483647
# 121 "q6.c"
                                +1.0))) / (2 * alpha);
