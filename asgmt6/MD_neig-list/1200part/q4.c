...
int main()
{
        ...
        int n = 1200; // Number of particles
        ...
        int *n_list = (int *)malloc(n * n * sizeof(int));
        int *n_track_list = (int *)malloc((n+1) * sizeof(int));
        ...
        neighbour_list(x_position, y_position, z_position, KbT, dt, r_c, mass, 
                        n_calc, n, box_size, n_list, n_track_list);
        force_calc(sigma, epsilon, x_position, y_position, z_position, r_c,
                        x_force, y_force, z_force, n, box_size, n_track_list, n_list);
        ...
        for(int i=0; i < n_iter; i++){
                ...
                force_calc(sigma, epsilon, x_position, y_position, z_position, r_c, x_force_new, 
                                y_force_new, z_force_new, n, box_size, n_track_list, n_list);
                ...
                if(i>49999){
                        if(i%n_update == 0){
                                ...
                                PE = calculate_PE(x_position, y_position, z_position, r_c, n, box_size,
                                                sigma, epsilon);
                                pair_correlation(x_position, y_position, z_position, box_size, n, dr,
                                                pair_cf, n_iter, n_update);
                                mb_check(x_velocity, y_velocity, z_velocity, n_iter, n_update,
                                                speed_mb, dv, num_v_bins, n);
                                fprintf(fPtr, "%f\n", KE);
                                fprintf(fPt, "%f\n", PE);
                        }
                }
