...
plt.plot(q4,'-')
plt.title('Energy at each iteration(KbT=3.9,L=30)')
...
plt.plot(q5_E,'-')
plt.title('Energy at each iteration(KbT=4.05,L=30)')
plt.ylabel('Energy per spin')
plt.xlabel("Iteration")
plt.show()
...
plt.plot(q6_E_24, '-')
plt.title('Energy at each iteration(KbT=3.9,L=24)')
plt.ylabel('Energy per spin')
plt.xlabel("Iteration")
plt.show()
...
plt.plot(q6_E_36, '-')
plt.title('Energy at each iteration(KbT=3.9,L=36)')
plt.ylabel('Energy per spin')
plt.xlabel("Iteration")
plt.show()
